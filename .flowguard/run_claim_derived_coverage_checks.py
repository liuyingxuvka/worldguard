...
ALIGNMENT = {
    ...
    "current_skillguard_authority": (
        ...
        "FORBIDDEN_V1_FILES",
        "test_expanded_residual_scan_blocks_generic_checker_and_mutable_report",
    ),
    "former_skillguard_authority_retirement": (
        "scripts/verify_guard_simulation_readiness.py",
        "residual_count",
        "test_narrow_receipt_cannot_hide_residual_and_parity_is_exact",
    ),
